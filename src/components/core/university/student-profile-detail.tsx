            ...
            <CardHeader className="flex flex-row items-center justify-between">
                <div className="flex items-center gap-4">
                    <Avatar className="w-16 h-16">
                        <AvatarFallback className="bg-blue-500 text-white text-lg font-bold">{userData[FIELD_PARAMS.FIRST_NAME].charAt(0).toUpperCase()}{userData[FIELD_PARAMS.LAST_NAME].charAt(0).toUpperCase()}</AvatarFallback>
                    </Avatar>
                ...
                <Badge className={userData.status ? "bg-[#84CC16] text-white" : "bg-red-500 text-white"}>
            ...
            <CardContent>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {[
                        ...
                        <Card key={index} className="flex items-center rounded-md justify-between px-5 py-6">
                            ...
                            {item.action && <Button variant="ghost" size="sm">{item.action}</Button>}
                        </Card>
                    ))}
                </div>
            </CardContent>
